...
class TranscriptionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Transcription
        fields = ('id', 'text', 'language', 'confidence_score', 'processing_time', 
...
class AudioFileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AudioFile
        fields = ('id', 'file', 'original_filename', 'file_size', 'duration', 
                 'status', 'created_at', 'updated_at', 'transcription')
        read_only_fields = ('id', 'file_size', 'duration', 'status', 'created_at', 'updated_at')
